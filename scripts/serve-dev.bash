fast-live-reload --serve http://localhost:4200 --delay 2700 --add-path controllers --add-path middleware --add-path src --add-path public --add-path views --add-path locales &

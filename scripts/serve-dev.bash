fast-live-reload --serve http://localhost:4200 --delay 3000 --add-path controllers --add-path middleware --add-path src --add-path public --add-path views --add-path locales &
